...
//  CatchTheKenny
//
//  Created by Nabeel-Ahmed on 27/02/2023.
//
    ...
    @objc func decreaseCounter() {
        ...
        if counter == 0 {
            ...
            if self.score > self.highScore {
                ...
                UserDefaults.standard.set(self.highScore, forKey: "highestScore")
            }
